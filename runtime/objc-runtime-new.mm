...
//            通过_getObjc2SelectorRefs拿到Mach_O中的静态段__objc_selrefs
...
findMethodInSortedMethodList(SEL key, const method_list_t *list)
{
    ...
    uint32_t count;
    //  say666(4294983200)   (sayMaster)4294983207 sayNB(4294983217) sayHello(4294983278)
    // array =  [1 2 3 4 5]
    // 1 : 0x001
    /**
     二分查找
...
IMP lookUpImpOrForward(id inst, SEL sel, Class cls, int behavior)
{
    ...
    for (unsigned attempts = unreasonableClassCount();;) {
        ...
        // Superclass cache.
        // 缓存 - lookupimp - 慢速 -
        // 自己验证 当前类的 缓存 teacher - person - NSObject - nil
